...
function handleSwipe() {
    if (touchendX < touchstartX) {
        // swipe left
        console.log("User is trying to swipe left");
    }
    if (touchendX > touchstartX) {
        // swipe right
        console.log("User is trying to swipe right");
    }
    if (touchendY < touchstartY) {
      //swipe down
      console.log("User is trying to swipe down");
    }
    if (touchendY > touchstartY) {
      //swipe up
      console.log("User is trying to swipe up");
    }
    if (touchendY == touchstartY) {
      //tapped
        console.log("User is tapping something!");
    }
}
